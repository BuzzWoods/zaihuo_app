...
class SalerSection extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ScreenUtil.init(context,
        designSize: Size(750, 1334), allowFontScaling: false);
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  _optionItem(Icons.assignment, '我的发布'),
                  _optionItem(Icons.outlined_flag, '我的卖出'),
                  _optionItem(Icons.brightness_5, '售后处理'),
                  _optionItem(Icons.verified_user, '保证金管理')
                ],
              ),
            )
          ],
